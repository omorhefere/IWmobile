...
var app = {
  ...
  receivedEvent: function(id) {
    ...
    $("#form").on("submit", function(e) {
                    ...
                    if (data.isFound === true) {
                      ...
                      if (data.tweets.length !== 0) {
                        ...
                        $("#tweetsResult").append('<div class="collapse" id="apiTweets"></div>');
                          ...
                          $("#apiTweets").append('<div class="panel panel-success panel-tweet" style="margin-top: -10%;"> \
                                                <div class="panel-heading"><a class="tweet-user" href="https://www.twitter.com/' + tweetsArray[t].user.screen_name + '" target="_blank">@' + tweetsArray[t].user.screen_name + '</a></div> \
                        ...
                        $("#tweetsResult").append('<button style="display: block;  margin-bottom: 10%;" class="btn btn-primary tweet-tab" disabled>There is 0 new tweet from API <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true"></span></button>');
                      }
                      ...
                      if (data.dbTweets) {
                        ...
                        for (t = 0 ; t < dbTweetsArray.length ; t++) {
                          ...
                          $("#dbTweets").append('<div class="panel panel-success panel-tweet" style="margin-top: -10%;"> \
                                                <div class="panel-heading"><a class="tweet-user" href="https://www.twitter.com/' + dbTweetsArray[t].username + '" target="_blank">@' + dbTweetsArray[t].username + '</a></div> \
      ...
      alert("Please enter a player, team or author!")
    }
    });
